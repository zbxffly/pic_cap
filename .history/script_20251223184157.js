...
function updatePreview() {
    ...
    subtitleOverlay.style.height = `${subtitleHeight.value}px`;
    subtitleOverlay.style.fontSize = `${fontSize.value}px`;
    subtitleOverlay.style.color = fontColor.value;
    subtitleOverlay.style.textShadow = `0 0 2px ${outlineColor.value}, 0 0 2px ${outlineColor.value}, 0 0 2px ${outlineColor.value}, 0 0 2px ${outlineColor.value}`;
    subtitleOverlay.style.fontFamily = fontFamily.value;
    subtitleOverlay.style.fontWeight = fontWeight.value;
    subtitleOverlay.textContent = subtitleContent.value;
}
